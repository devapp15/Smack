...
import com.trvrx.smack.Model.Channel
import com.trvrx.smack.Model.Message
import com.trvrx.smack.Utilities.URL_GET_CHANNEL
import com.trvrx.smack.Utilities.URL_GET_MESSAGES
...
object MessageService {
    ...
    fun getChannels(complete: (Boolean) -> Unit) {
        ...
        val channelsRequest = object : JsonArrayRequest(Method.GET, URL_GET_CHANNEL, null, Response.Listener {
            response ->
            try {
